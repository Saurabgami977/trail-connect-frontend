...
export default function TrekDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white mt-20">
      ...
      {/* Sticky Stats Bar */}
      <div className="bg-white border-b z-40 shadow-md">
        <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            {/* Tabs */}
            <div className="bg-white rounded-2xl shadow-lg border overflow-hidden mb-8 relative">
              <div className="border-b sticky top-0 z-30 bg-white shadow-sm">
